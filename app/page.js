                ...
                <div className="fadein" style={{background:"#fff",border:"1px solid #e2e8f0",borderRadius:16,padding:"16px",boxShadow:"0 4px 20px rgba(0,0,0,.06)"}}>
                  ...
                  {openTool==="screenshot" && (
                    <div id="screenshot-section">
                      ...
                      {screenshotPreview&&<img src={screenshotPreview} alt="" style={{width:"100%",borderRadius:12,marginBottom:10,border:"1px solid #e2e8f0"}}/>}
                      {screenshotPreview&&(
                        <button className="btn" onClick={analyzeScreenshot} disabled={screenshotLoad} style={{width:"100%",padding:"11px",borderRadius:12}}>
                          {screenshotLoad?"⟳ Analyzing…":"🔍 AI Se Analyze Karo"}
                        </button>
                      )}
                      {screenshotText&&<div style={{marginTop:10,background:"linear-gradient(135deg,#ecfdf5,#f0fdf4)",border:"1px solid #6ee7b7",borderRadius:14,padding:"14px",fontSize:12,color:"#065f46",lineHeight:1.7,whiteSpace:"pre-wrap"}}>{screenshotText}</div>}
                    </div>
                  )}
                  ...
                  {openTool==="advice" && (
                    <div id="advisor-section">
                      ...
                      <textarea value={adviceQ} onChange={e=>setAdviceQ(e.target.value)}
                      ...
                      <button className="btn" onClick={getPersonalAdvice} disabled={adviceLoad||!adviceQ.trim()} style={{width:"100%",padding:"11px",borderRadius:12,marginTop:10,background:"linear-gradient(135deg,#ef4444,#dc2626)"}}>
