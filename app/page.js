      ...
      <div style={{maxWidth:700,margin:"0 auto",padding:"28px 16px 56px",position:"relative",zIndex:1}}>
        ...
        <div style={{textAlign:"center",marginBottom:24}}>
          ...
          <div style={{display:"flex",justifyContent:"center",marginBottom:10}}>
            <img src="/yyp_logo.gif" alt="YES YOU PRO" style={{width:90,height:90,borderRadius:"50%",boxShadow:"0 0 24px rgba(16,185,129,.3)"}} onError={e=>e.target.style.display="none"}/>
          </div>
          <h1 style={{fontSize:36,fontWeight:900,letterSpacing:-2,lineHeight:1,marginBottom:6}}>
            <span style={{background:"linear-gradient(135deg,#0f172a,#1e293b 50%,#10b981)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}>YES YOU</span>
            <span style={{background:"linear-gradient(135deg,#10b981,#059669)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent"}}> PRO</span>
          </h1>
