        ...
        {activeTab==="analyze" && (
          <div className="fadein">
            ...
            <div className="hov" style={{...CARD,position:"relative",overflow:"hidden"}}>
              ...
              <SH icon="🏆" title="Daily Strong Signals" subtitle="Strict filter — sirf genuine buy opportunities"/>
              {!top5Fetched?(
            ...
            {/* ── PRICE ALERT ── */}
            <div className="hov" style={{...CARD,border:"2px solid #fde68a",background:"linear-gradient(135deg,#fff,#fffbeb)"}}>
