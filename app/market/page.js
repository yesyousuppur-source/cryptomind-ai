            ...
            {sorted.map((coin,i) => {
              ...
              return (
                <div key={coin.symbol} className="row"
                  onClick={()=>router.push(`/arena?coin=${coin.symbol}&action=buy`)}
                  style={{background:"#fff",borderRadius:14,marginBottom:6,padding:"11px 14px",
                    ...
                    transition:"all .15s",boxShadow:"0 1px 4px rgba(0,0,0,.03)",cursor:"pointer"}}>
                  ...
                  <div style={{flexShrink:0}}>
                    ...
                    <div style={{fontSize:9,color:"#10b981",fontWeight:700,textAlign:"center",marginTop:3}}>Trade →</div>
                  </div>
                </div>
              );
            })}
